...
def follow(head,tail):
    if any([abs(head[idx]-tail[idx])==2 for idx in range(2)]) and any([abs(head[idx]-tail[idx])==1 for idx in range(2)]) or all([abs(head[idx]-tail[idx])==2 for idx in range(2)]):
